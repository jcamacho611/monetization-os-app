...
function buildAuditInput(client, siteSummary) {
  return [
    ...
    'This is not a generic website review. It is a trust scan for founders, operators, families, creators, and teams reading a high-signal source, which may be a website, message, profile, clip, offer, or plain text prompt.',
